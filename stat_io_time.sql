...
ALTER TABLE _query_stats.stat_io_time
  OWNER TO postgres;
GRANT ALL ON TABLE _query_stats.stat_io_time TO postgres;
GRANT SELECT ON TABLE _query_stats.stat_io_time TO "storage-api";
GRANT SELECT ON TABLE _query_stats.stat_io_time TO "php-api";
